...
<body>
	<div class="logo">
		<img src="" alt="FARMERS FRIEND">
	</div>
	<!-- <a href="loginservlet">Click here</a> -->
	<div class="login-box">
		<img class="avatar" src="Images/avatar.png">
		<h1>Login Here</h1>
		<form name="dharani" action="loginservlet" method="post">
			<div>
				<i class="fas fa-user fa-1x cust"></i> <input name="username"
					type="text" placeholder="UserID"> <i
					class="fas fa-lock fa-1x cust"></i> <input name="password"
